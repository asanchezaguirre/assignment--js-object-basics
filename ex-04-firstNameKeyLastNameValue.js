...
function firstNameKeyLastNameValue(nombre1, nombre2, nombre3){
	var separarNombre1 = nombre1.split(" ");
	var separarNombre2 = nombre2.split(" ");
	var separarNombre3 = nombre3.split(" ");
	
	var objeto = {};
	objeto[separarNombre1[0]] = separarNombre1[1];
	objeto[separarNombre2[0]] = separarNombre2[1];
	objeto[separarNombre3[0]] = separarNombre3[1];
